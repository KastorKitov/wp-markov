			...
			<div class="kastor-machine__hero">
				...
				<?php if ( $has_body ) : ?>
					<div class="kastor-machine__body">
						...
						<div class="kastor-machine__ctas">
							<a class="kastor-machine__cta" href="<?php echo esc_url( home_url( '/контакти/' ) ); ?>">
								Свържете се с нас
							</a>
							<a class="kastor-machine__cta-phone" href="tel:+359879156316" aria-label="Обади се на +359 879 156 316" title="+359 879 156 316">
